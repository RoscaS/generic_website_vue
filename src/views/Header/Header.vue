<template>
  <div>
    <section id="Home" class="section header-wrapper">
      <EditIcon :edit="edit" :store="store"/>
        ...
        <div class="columns">
            ...
            <div class="_center">
              ...
              <transition name="subtitle-fade-in" appear>
                <div class="_subtitle">
                  ...
                  <span :class="{'highlighted': highlighted(2)}">
                    {{ state.oppening.data}}
                  </span>
                </div>
              </transition>
          ...
          <div class="column is-3 is-hidden-mobile">
            <div class="_sides _right"
              ...
              <span class="second-line">
                ...
                , tel.:
                <a class="phone"
                   :class="{'highlighted': highlighted(6)}"
                   :href="phoneHref">
                  {{state.phone.data}}
                </a>
            </span>
          ...
          <div class="column is-12 is-hidden-tablet _mobile">
            ...
            <transition name="bounceRight" appear>
              <div class="_bottom">
                <span class="first-line">{{ upper(state.adress.data) }}</span>
                <span class="second-line">
                  {{ state.post_code.data }} {{ upper(state.city.data) }}, tel.:
                <a class="no-tr" :href="phoneHref">{{state.phone.data}}</a>
              </span>
              </div>
            </transition>
          </div>
